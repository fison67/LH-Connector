...
metadata {
	definition (name: "Samsung Smart Doorlock", namespace: "fison67", author: "fison67") {
		capability "Actuator"
		capability "Lock"
		capability "Battery"
        ...
        attribute "lockType", "string"
        attribute "lastOpenType", "string"
        attribute "lastOpenPerson", "string"
	...
	preferences {
        input name: "selectedLang", title:"Select a language" , type: "enum", required: true, options: ["English", "Korean"], defaultValue: "Korean", description:"Language for DTH"
	}
...
private def parseCommandResponse(String description) {
	...
	if (clusterInt == CLUSTER_DOORLOCK && (cmd == DOORLOCK_CMD_LOCK_DOOR || cmd == DOORLOCK_CMD_UNLOCK_DOOR)) {
        ...
        sendEvent(name: "lockCode", value: eventIdValue, displayed: false)
        sendEvent(name: "lockTypeId", value: eventSource, displayed: false)
